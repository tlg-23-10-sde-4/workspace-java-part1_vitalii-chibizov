...
public class PoemClient {
    ...
    private static void writePoem() {
            try (PrintWriter writer = new PrintWriter(new FileWriter("My haiku.txt"))) {
                writer.println("Darkness in my mind");
                writer.println("We all pretend, we understand");
                writer.println("But effort worthless");
                /*System.out.println("" +
                        "Darkness in my mind\n" +
                        "We all pretend, we understand\n" +
                        "But effort worthless");*/
            }
            catch (IOException e) {
                e.printStackTrace();
            }
